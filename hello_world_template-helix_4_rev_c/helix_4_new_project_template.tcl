...
set_global_assignment -name SYSTEMVERILOG_FILE ./hdl/helix_4_top_level.sv
...
set_global_assignment -name TOP_LEVEL_ENTITY helix_4_top_level
...
set_location_assignment PIN_P2 -to gpio[22]
set_location_assignment PIN_T4 -to gpio[23]
set_location_assignment PIN_R4 -to gpio[24]
#bank 3, 4, ref 2V5 ONLY - these are the PLL_CLKOUT pins
set_location_assignment PIN_N14 -to gpio[25]
set_location_assignment PIN_P15 -to gpio[26]
set_location_assignment PIN_R14 -to gpio[27]
set_location_assignment PIN_P14 -to gpio[28]
#bank 5, ref VCCIO5
set_location_assignment PIN_N15 -to gpio[29]
set_location_assignment PIN_N16 -to gpio[30]
set_location_assignment PIN_R16 -to gpio[31]
set_location_assignment PIN_P16 -to gpio[32]
set_location_assignment PIN_L13 -to gpio[33]
set_location_assignment PIN_L14 -to gpio[34]
set_location_assignment PIN_L16 -to gpio[35]
set_location_assignment PIN_L15 -to gpio[36]
...
#these are pins from banks 6,7,8, and are set here as 1.8V. If you are usings
#a module that doesn't have DRAM you should modify or remove these lines 
#(so they default to 3.3V)
...
set_instance_assignment -name IO_STANDARD "1.8 V" -to gpio[39]
#end GPIO
...
set_instance_assignment -name IO_STANDARD "SSTL-18 CLASS I" -to dram_ba[2]
